...
if __name__ == '__main__':
    ...
    pred_filepath = "/dev/shm/vnhh/pred.txt" # get_temp_filepath()
    source_filepath = "/dev/shm/vnhh/source.txt" # get_temp_filepath()
    ...
    output_file = "/data1/home/vnhh/mnli_simplified/mnli_simplified_sentences/train_sent2_sim.txt"
    try:
